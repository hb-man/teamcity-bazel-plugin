...
- In BES (gRPC) mode a failed build no longer repeats Bazel's `ERROR:`/`FATAL:` stderr lines at the end of the build log; the event stream has already reported them
